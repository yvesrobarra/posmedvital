...
Abrir `index.html` en cualquier navegador (PC, tablet o celular). Los datos se guardan en el navegador del equipo (localStorage): usar siempre el mismo equipo y navegador para conservar el historial.
